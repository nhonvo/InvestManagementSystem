...
{
    Task<AuthTokenPair> LoginAsync(LoginRequest request, CancellationToken ct = default);
    ...
    Task<AuthTokenPair> RefreshAsync(string refreshToken, CancellationToken ct = default);
}
